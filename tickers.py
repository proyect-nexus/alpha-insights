...
SP500 = [
    ...
    "ADI", "AON", "APA", "AAPL", "AMAT", "APTV", "ACGL", "ADM",
    ...
    "CAT", "CBOE", "CBRE", "CDW", "CE", "COR", "CNC", "CNP",
    ...
    "DE", "DAL", "DVN", "DXCM", "FANG", "DLR", "DG", "DLTR",
    "D", "DPZ", "DOV", "DOW", "DTE", "DUK", "DD", "EMN",
    ...
    "PANW", "PH", "PAYX", "PAYC", "PYPL", "PNR", "PEP", "PFE",
    "PCG", "PM", "PSX", "PNW", "PNC", "POOL", "PPG", "PPL",
    ...
    "VTRS", "VICI", "V", "VMC", "WRB", "WAB", "WMT", "DIS",
    "WBD", "WM", "WAT", "WEC", "WFC", "WELL", "WST", "WDC",
...
BIOTECH = [
    ...
    "DXCM", "ISRG", "IOVA", "BNTX", "CRSP",
]

# Energia
ENERGY = [
    "XOM", "CVX", "COP", "EOG", "SLB", "MPC", "VLO", "PSX",
    "DVN", "OXY", "FANG", "HAL", "BKR", "TRGP", "OKE", "WMB",
    "KMI", "ET",
]
